    ...
    <section className={style.about} aria-labelledby={TITLE}>
      <div className={cn(style.inner, 'container')}>
        ...
        <div className={style.titlesAbout}>
          ...
          <h2 id={TITLE} className={cn(style.title, 'h5')}>
            An award-winning design & dev team that is proud of our work 👋
          </h2>
        </div>
        <div className={style.text}>
          <p className={style.leftCol}>
            Over 10 years of combined experience, and know a thing or two about
            designing websites and mobile apps.
          </p>
          <p className={style.rightCol}>
            Were divided, a moved night light darkness winged may also make man
            for. Winged the for Earth creeping appear evening, gathered Forth so
            he. Life that dry of created greater can`&apo`t also gathered female
            green.
          </p>
